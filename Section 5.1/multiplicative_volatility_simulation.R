...
# The considered linear SDE admits closed form solution, thus we compare our simulated results with the analytically obtained ground truth. We compare the weak error of the mean and standard deviation across the Monte Carlo iterations for each of the three schemes. 
...
save(error_total, file = "multiplicative_volatility_data.RData")
